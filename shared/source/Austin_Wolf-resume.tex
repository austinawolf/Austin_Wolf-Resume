  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Optimized continuous integration/release build pipeline to reduce build times by 6x and improve pain points in deployment workflow}
      \resumeItemListEnd
    \resumeSubheading
      ...
      product development teams}
        \resumeItem{Project Recell: led implementation of full closed-loop PID motor control stack on STM32F4 processor for precise robotic skin cell disaggregation using complex coordinate motion}
        ...
        \resumeItem{Project Smart Capsule: resolved critical power management issues and optimized manufacturing workflow in ingestible electromechnical pill-sized prototype medical device running on STM32L0}
